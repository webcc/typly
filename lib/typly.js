...
function isNullAndIgnoreNullValues(value) {
  return ignoreNullValues && (value === null);
}

module.exports = {
  config(config) {
    ignoreNullValues = getValue(config, 'ignoreNullValues', false);
    return this;
  },
  /**
  ...
  isInstanceOf(value, prototype) {
      if(isNullAndIgnoreNullValues(value)) {
        return true;
      }
