    ...
    isImplementationOf: function (_object, _class)
    {
        if(_object instanceof _class) {
            ...
            if(this.isNull(_object) || !this.isObject(_object) || !this.isFunction(_class))
            {
                ...
                let classPropertyNames = Object.getOwnPropertyNames(new _class());
                return classPropertyNames.length === _.intersection(classPropertyNames, objectPropertyNames).length;
            }
        }
    },
